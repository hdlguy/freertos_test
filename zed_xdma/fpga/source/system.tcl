...
proc create_root_design { parentCell } {
  ...
  set frame_size [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 frame_size ]
  ...
  set stream [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 stream ]
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {stream} \
 ] $axi_aclk
  set axi_aresetn [ create_bd_port -dir O -from 0 -to 0 -type rst axi_aresetn ]
  set dma_introut [ create_bd_port -dir O -type intr dma_introut ]
  ...
  connect_bd_intf_net -intf_net S_AXIS_S2MM_0_1 [get_bd_intf_ports stream] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
connect_bd_intf_net -intf_net [get_bd_intf_nets S_AXIS_S2MM_0_1] [get_bd_intf_ports stream] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXI_SG] [get_bd_intf_pins axi_dma_0/M_AXI_SG] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports pmod] [get_bd_intf_pins axi_gpio_1/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports frame_size] [get_bd_intf_pins axi_gpio_2/GPIO]
