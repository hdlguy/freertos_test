...
proc create_root_design { parentCell } {
  ...
  set ddr3_sdram [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddrx_rtl:1.0 -portmaps { \
   ADDR { physical_name ddr3_sdram_addr direction O left 13 right 0 } \
   BA { physical_name ddr3_sdram_ba direction O left 2 right 0 } \
   CAS_N { physical_name ddr3_sdram_cas_n direction O } \
   CK_N { physical_name ddr3_sdram_ck_n direction O left 0 right 0 } \
   CK_P { physical_name ddr3_sdram_ck_p direction O left 0 right 0 } \
   CKE { physical_name ddr3_sdram_cke direction O left 0 right 0 } \
   CS_N { physical_name ddr3_sdram_cs_n direction O left 0 right 0 } \
   DM { physical_name ddr3_sdram_dm direction O left 1 right 0 } \
   DQ { physical_name ddr3_sdram_dq direction IO left 15 right 0 } \
   DQS_N { physical_name ddr3_sdram_dqs_n direction IO left 1 right 0 } \
   DQS_P { physical_name ddr3_sdram_dqs_p direction IO left 1 right 0 } \
   ODT { physical_name ddr3_sdram_odt direction O left 0 right 0 } \
   RAS_N { physical_name ddr3_sdram_ras_n direction O } \
   RESET_N { physical_name ddr3_sdram_reset_n direction O } \
   WE_N { physical_name ddr3_sdram_we_n direction O } \
   } \
  ddr3_sdram ]
  set_property -dict [ list \
   CONFIG.CAN_DEBUG {false} \
   ] $ddr3_sdram
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports ddr3_sdram]

  set eth_mdio_mdc [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:mdio_rtl:1.0 -portmaps { \
   MDC { physical_name eth_mdio_mdc_mdc direction O } \
   MDIO_I { physical_name eth_mdio_mdc_mdio_i direction I } \
   MDIO_O { physical_name eth_mdio_mdc_mdio_o direction O } \
   MDIO_T { physical_name eth_mdio_mdc_mdio_t direction O } \
   } \
  eth_mdio_mdc ]
  set_property -dict [ list \
   CONFIG.CAN_DEBUG {false} \
   ] $eth_mdio_mdc
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports eth_mdio_mdc]

  set eth_mii [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:mii_rtl:1.0 -portmaps { \
   COL { physical_name eth_mii_col direction I } \
   CRS { physical_name eth_mii_crs direction I } \
   RST_N { physical_name eth_mii_rst_n direction O } \
   RX_CLK { physical_name eth_mii_rx_clk direction I } \
   RX_DV { physical_name eth_mii_rx_dv direction I } \
   RX_ER { physical_name eth_mii_rx_er direction I } \
   RXD { physical_name eth_mii_rxd direction I left 3 right 0 } \
   TX_CLK { physical_name eth_mii_tx_clk direction I } \
   TX_EN { physical_name eth_mii_tx_en direction O } \
   TXD { physical_name eth_mii_txd direction O left 3 right 0 } \
   } \
  eth_mii ]
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports eth_mii]

  set qspi_flash [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 -portmaps { \
   IO0_I { physical_name qspi_flash_io0_i direction I } \
   IO0_O { physical_name qspi_flash_io0_o direction O } \
   IO0_T { physical_name qspi_flash_io0_t direction O } \
   IO1_I { physical_name qspi_flash_io1_i direction I } \
   IO1_O { physical_name qspi_flash_io1_o direction O } \
   IO1_T { physical_name qspi_flash_io1_t direction O } \
   IO2_I { physical_name qspi_flash_io2_i direction I } \
   IO2_O { physical_name qspi_flash_io2_o direction O } \
   IO2_T { physical_name qspi_flash_io2_t direction O } \
   IO3_I { physical_name qspi_flash_io3_i direction I } \
   IO3_O { physical_name qspi_flash_io3_o direction O } \
   IO3_T { physical_name qspi_flash_io3_t direction O } \
   SCK_I { physical_name qspi_flash_sck_i direction I } \
   SCK_O { physical_name qspi_flash_sck_o direction O } \
   SCK_T { physical_name qspi_flash_sck_t direction O } \
   SS_I { physical_name qspi_flash_ss_i direction I } \
   SS_O { physical_name qspi_flash_ss_o direction O } \
   SS_T { physical_name qspi_flash_ss_t direction O } \
   } \
  qspi_flash ]
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports qspi_flash]

  set usb_uart [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 -portmaps { \
   RxD { physical_name usb_uart_rxd direction I } \
   TxD { physical_name usb_uart_txd direction O } \
   } \
  usb_uart ]
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports usb_uart]


  # Create ports
  set axi_aclk [ create_bd_port -dir O -type clk axi_aclk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M06_AXI} \
 ] $axi_aclk
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_ports M06_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_ports eth_refclk] [get_bd_pins clk_wiz_0/clk_out3]
  ...
  connect_bd_net -net reset_1 [get_bd_ports resetn] [get_bd_pins clk_wiz_0/resetn]
  ...
  connect_bd_net -net rst_mig_7series_0_83M_peripheral_aresetn [get_bd_ports axi_aresetn] [get_bd_pins axi_ethernetlite_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_83M/peripheral_aresetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]

  # Create address segments
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs M06_AXI/Reg] -force
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs M06_AXI/Reg] -force
